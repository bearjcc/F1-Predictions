	...
	render() {
		return (
			<div className="draggy">
				<img src="../img/icons/drag.png" alt="drag"/>
			</div>
		)
	}
}

class Flag extends React.Component<{country:string}> {
	render() {
		return (
...
class Position extends React.Component<{position:number}> {
...
class DriverNumber extends React.Component<{ obj: { name: string, number: number } }> {
	render() {
		return (
			<div className="number">
				<img className="driverNumber" src={require(`../img/icons/${this.props.obj.name}.png`)} alt={this.props.obj.number.toString()} />
			</div>
		);
	}
}

class Name extends React.Component<{ largeName: string, smallName: string, smallFirst: Boolean}> {
	render() {
		return (
