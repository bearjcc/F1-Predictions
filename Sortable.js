			...
			_objectSpread2(
				{
					...
					dispatchSortableEvent: function dispatchSortableEvent(
						name
					) {
						_dispatchEvent({
							sortable: sortable,
				...
				setData: function setData(dataTransfer, dragEl) {
					...
					if (
						...
						multiDragElements.forEach(function (
							...
							data +=
								(!i ? "" : ", ") + multiDragElement.textContent;
						});
					} else {
						...
						if (!initialFolding) {
							if (options.animation) {
								...
								multiDragElements.forEach(function (
									...
									multiDragElement.thisAnimationDuration =
										null;
